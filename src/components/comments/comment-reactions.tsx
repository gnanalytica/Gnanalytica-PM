    ...
    <div className="flex items-center gap-1 flex-wrap">
      ...
      <div className="relative">
        <button
          ...
          className="w-6 h-6 rounded-full bg-surface-secondary hover:bg-hover flex items-center justify-center text-content-muted text-[11px] transition-colors"
        >
          +
        </button>
        {showPicker && (
          <>
            ...
            <div className="absolute bottom-full left-0 mb-1 bg-surface-tertiary border border-border-subtle rounded-md z-20 p-1 flex gap-0.5">
              {QUICK_REACTIONS.map((emoji) => (
                <button
                  ...
                  className="w-7 h-7 rounded hover:bg-hover flex items-center justify-center text-sm transition-colors"
                >
                  {emoji}
                </button>
              ))}
