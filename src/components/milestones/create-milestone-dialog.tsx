        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex justify-end gap-2 pt-1">
            <button
              type="button"
              onClick={onClose}
              className="px-3 py-1.5 text-xs text-gray-700 hover:bg-hover active:scale-[0.96] rounded-md transition-all duration-150"
            >
              Cancel
            </button>
            <button
              ...
              className="px-3 py-1.5 text-xs bg-blue-600 text-white rounded-md hover:bg-blue-700 active:scale-[0.97] disabled:opacity-50 transition-all duration-150"
            >
